...
{
	__STM32_PIN(0, APB2, B, 0),      //LED       RUN light
    __STM32_PIN(1, APB2, B, 1),		  //LED2		  指示灯
    __STM32_PIN(2, APB2, A, 1),     //PowCtr	  电源控制	
    __STM32_PIN(3, APB2, C, 4),     //Fdog			喂狗控制
	__STM32_PIN(4, APB2, A, 0),       //GU620         电源控制
